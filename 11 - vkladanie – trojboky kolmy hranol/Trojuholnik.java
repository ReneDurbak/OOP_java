...
class Trojuholnik{
  ...
  //====================konstruktor====================
  public Trojuholnik(){
    System.out.println("----ZADAJ HODNOTY PRE TROJUHOLNIK---");
    ...
    }while((OverTrojuholnik.overTrojuholnik(stranaA, stranaB, stranaC))==false);
    /*ak by metoda overTrojuholnik nebola static, tak by smne volali:
    OverTrojuholnik ov = new OverTrojuholnik();
    */
