...
public class Student extends Osoba{  //Trieda Student je rozsirenim Triedy Osoba
  ...
  public Student( String meno,String priezvisko,int datumNarodenia, String pohlavie,float vyska,float vaha, String odbor,String trieda,float priemer,int dochadzka){
