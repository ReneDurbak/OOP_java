...
public class GenerujTvar{
  ...
  public static void main(String arg[]){
    ...
    Obdlznik obdA = new Obdlznik(5.7F,4.0F,"RED"); //explicitny konsturktor
    ...
    Obdlznik obdB = new Obdlznik(5.4F,6.2F,"RED");     
     obdB.info();
    ...
    //DOMACA - porovnavanie objektov pomocou equals
    
     if (obdB.hashCode() == obdA.hashCode()) {
      System.out.println(obdB.equals(obdA));   //Ak sa rovna(aj farba sa musi rovnat) bude - true, ak nie, tak false
