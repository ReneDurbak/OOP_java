...
public void setStranaA(float stranaA){
  ...
  //Predefinovanie metody toString
  //metodu toString predefinujeme a navratova hodnota bude znakovy retazec vsetkych datovych poloziek - nepisane pravidlo
  public String toString(){
  
    return stranaA + " " + stranaB + " " + farba + " ";
  ...
  public void info(){
    ...
    System.out.println("Pocet vytvorenych obdlznikov: "+ pocetObdzlnikov());
    //volanie metody z rodicovskej triedy Object
    ...
    // pomocou slovicka super viem pristupit k povodnym metodam ktore su zadefinovane v rodicovskych triedach, 
    //zmenili sme predefinovaim navratovu hodnotu ale pomocou super sa viem dostat k povodnym metoda i ich navratovym hodnotam
    
    //vrati vsetky hodnoty datovych poloziek vo forme retazca(String)
...
public static float overRozmer(Scanner userValue, char pismenko){
  ...
  //DU---- - POROVNAVANIE - HashCode a Equals
 ...
 @Override
  public boolean equals(Object obj) {
    ...
    Obdlznik emp = (Obdlznik) obj;

    return this.farba.equals(emp.farba) && this.stranaA == emp.stranaA && this.stranaB == emp.stranaB;
  }

  @Override
  public int hashCode() {
    return this.farba.length();
  }
