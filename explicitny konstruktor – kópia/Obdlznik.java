...
class Obdlznik{
  ...
  public Obdlznik(){
    ...
    */
    ...
    this.stranaA = overRozmer(userValue, 'a');   //test strany od uzivatela ci nie je zaporna alebo nulova
    ...
    */
     ...
     this.stranaB = overRozmer(userValue, 'b');  //test strany od uzivatela ci nie je zaporna alebo nulova
...
public float overRozmer(Scanner userValue, char pismenko){
